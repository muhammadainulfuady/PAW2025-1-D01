...
(1, 'Ainulfuady', 'admin', 'e66055e8e308770492a44bf16e875127');
...
INSERT INTO `dokumen` (`ID_DOKUMEN`, `ID_PENDAFTARAN`, `KETERANGAN`, `JENIS_DOKUMEN`, `PATH_FILE`) VALUES
(17, 9, 'Akte Kelahiran Siswa', 'Akte Kelahiran', 'doc_691f35e28b600.jpg'),
(18, 9, 'Kartu Keluarga Siswa', 'Kartu Keluarga', 'doc_691f35e28d47d.jpg');
...
INSERT INTO `pendaftaran` (`ID_PENDAFTARAN`, `ID_JURUSAN`, `USERNAME_SISWA`, `NISN`, `JENIS_KELAMIN`, `TANGGAL_LAHIR`, `TEMPAT_LAHIR`, `NO_HP_SISWA`, `TANGGAL_PENDAFTARAN`, `ASAL_SEKOLAH`, `ALAMAT`, `NAMA_WALI`, `NO_HP_WALI`, `STATUS`, `PROGRAM_PONDOK`) VALUES
(9, 7, 'AinulFuady24', '1234567890', 'L', '2006-05-18', 'Bungah Gresik', '085808406486', '2025-11-20 22:38:10', 'Smks Nurul Hidayah', 'Pereng kulon, Melirang, Bungah, gresik', 'Amin Thohari', '085808406489', '2', 'Tahfidz Alquran');
...
('AfifUddin', 'Muhammad Afifuddin', 'default.jpg', '92cd760cae9061910fa475bb66d491e5'),
('AinulFuady24', 'Muhammad Ainul Fuady', '691f356214443.jpg', 'ea1907de8478edf88bcb9860c4b715dd');
...
--
ALTER TABLE `pendaftaran`
  ADD CONSTRAINT `FK_MELAKUKAN` FOREIGN KEY (`USERNAME_SISWA`) REFERENCES `siswa` (`USERNAME_SISWA`) ON DELETE RESTRICT ON UPDATE RESTRICT,
